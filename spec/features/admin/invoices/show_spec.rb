...
describe 'Admin Invoices Index Page' do
  ...
  it "shows that the total revenue includes bulk discounts in the calculation" do
    merchant_1 = Merchant.create!(name: 'Hair Care')

    discount_1 = merchant_1.discounts.create!(quantity: 3, percentage: 10)
    discount_2 = merchant_1.discounts.create!(quantity: 5, percentage: 15)
    discount_3 = merchant_1.discounts.create!(quantity: 12, percentage: 20)
