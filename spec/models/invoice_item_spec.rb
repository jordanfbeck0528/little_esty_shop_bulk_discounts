...
RSpec.describe InvoiceItem, type: :model do
  ...
  describe "instance_methods" do
    it 'finds top applicable discount' do
      @merchant_1 = Merchant.create!(name: 'Hair Care')
      @merchant2 = Merchant.create!(name: 'Jewelry')
      @discount_1 = @merchant_1.discounts.create!(quantity: 8, percentage: 20)
      ...
      @ii_11 = InvoiceItem.create!(invoice_id: @invoice_1.id, item_id: @item_8.id, quantity: 7, unit_price: 6, status: 1)
...
# require "pry"; binding.pry
      expect(@ii_1.top_applicable_discount).to eq(@discount_1.id)
      expect(@ii_11.top_applicable_discount).to be_nil
    end
  end
end
